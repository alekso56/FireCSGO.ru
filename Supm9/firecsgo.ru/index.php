			...
			<div id="main">
				<div class="sidebar">
					<nav id="nav">
						...
						<ul>
							...
							<li><a href="/about"><i class="fa fa-book" style="padding-right: 15px;"></i><?php echo $msg[$lang]["about"]; ?></a></li>
							<li><a href="http://vk.com/csgo_stf"><i class="fa fa-envelope-o" style="padding-right: 15px;"></i><?php echo $msg[$lang]["support"]; ?></a></li>
						</ul>
					</nav>
					<?php 
					if(isset($_SESSION["steamid"])) {
				...
				<header class='head'>
					...
					<div class="jackpot">
													...
													<?php 
													if(!isset($_SESSION["steamid"])) {
														echo "<a class=\"enter_btn\" href=\"?login\" id='money_round2'><i class=\"ico_enter_btn\"></i>".$msg[$lang]["login"]."<b>";
														echo round(fetchinfo("cost","games","id",$maxcost),2);
														echo "!</b>";
														echo "</a>";
													}
													?>			
						<p>Участвующие вносят скины, по достижении определенного максимального количества случайным образом выбирается победитель, который получит все скины. Шанс выигрыша зависит от стоимости внесенных скинов.</p>
					</div>
					<div class="items">
							<ul>
								<li>
						...
						<h3 style="text-align: left;"><?php echo $msg[$lang]["game"]; ?>: <?php echo $lastgame; ?></h3>
						<div class="game">
						<div class="progress">
							<div class="stuffs promo-cover">Играй вместе с нами!</div>
							<div class="visual">
								<div class="progressb">
									<div class="ghbfv" style="color: #fff;    font-size: 15px;    text-align: center;padding-top: 9px;font-weight: 800;">0/50</div>
									<div style="color: #fff;    font-size: 15px;    text-align: center;"> предметов</div>
						...
						<div class="rate">
							<div class="count" style="margin-right: 270px;padding: 15px 20px;">
								<div class="chance rcol" style="float: right;font-size: 17px;width: 150px;margin-top: 10px;">
									<p style="font: 500 25px/25px 'Roboto', sans-serif;  margin: 0;  width: 80px;  float: left;  color: #474747;"><?php echo $msg[$lang]["chance"]; ?></p>
						...
						if(!isset($_SESSION["steamid"])) echo '<div id="add_game"><a class="btwn_game" href="?login">'.$msg[$lang]["ingame"].'!</a></div>';
							...
							else echo '<div id="add_game"><a class="btwn_game" href="ССЫЛКА НА ОБМЕН" target=_blank>'.$msg[$lang]["ingame"].'!</a></div>';
						}
						?>
